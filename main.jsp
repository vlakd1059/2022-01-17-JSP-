...
<body>
	...
	<div id="wrapper">
		...
		<%
			if(member==null){%> <a href="#menu">로그인</a> <%}else{ %> <a
			href="update.jsp">개인정보수정</a> <a href="Logout.jsp">로그아웃</a> <!-- 로그인 후 Logout.jsp로 이동할 수 있는'로그아웃'링크와 '개인정보수정'링크를 출력하시오. -->
		<% } %> </nav> </header>
		...
		<div class="inner">
			...
			<!-- 로그인 후 로그인 한 사용자의 세션아이디로 바꾸시오. ex)smart님 환영합니다 --> <%}else{ %>
				...
				<%
					if(member==null){
						...
						if(msglist.isEmpty()){
							...
							out.print("<li><a href=\"#\"class=\"button next scrolly\">전체삭제하세요</a></li>");
						}
					}
